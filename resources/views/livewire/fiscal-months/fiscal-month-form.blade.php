<div>
    <div class="card">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    @if(!$fiscal_year_id)
                        <div class="form-text">{{ __('fiscal_months.fiscal_year_required') }}</div>
                    @endif
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-text">{{ __('fiscal_months.end_date_hint') }}</div>
        ...
        <div class="card-footer d-flex gap-2">
            <button type="button" class="btn btn-secondary" wire:click="$dispatch('cancelForm')">{{ __('global.cancel') }}</button>
            <button type="button" class="btn btn-primary" wire:click="save">{{ __('global.save') }}</button>
        </div>
    </div>
</div>
