    ...
    <div class="position-fixed top-0 start-0 p-3" style="z-index: 1050;">
        ...
        <a href="{{ LaravelLocalization::getLocalizedURL($nextLocale, null, [], true) }}" wire:navigate class="btn btn-light btn-sm rounded-circle shadow" title="{{ $nextLocale === 'ar' ? __('language.ar') : __('language.en') }}" aria-label="toggle-language">
